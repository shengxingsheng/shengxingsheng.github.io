...
​	The picture shows a direct transmission system.It means the propeller and shafts are driven by the main engine directly.The main items in the system include the thrust shaft, intermediate shaft, propeller shaft and propeller.They are supported by the intermediate bearing and stern tube bearing.
...
​	~~The moving parts shown in the illustration mainly include the piston, the connecting rod, and the crankshaft. They are all critical parts of the engine.~~ According to the specific condition in the illustration ,the piston and connecting rod are under the compressive stress, while the crankshaft is under the torsional stress.
...
​	The piston head in the illustration is of dished type and have four piston ring grooves. Most marine diesel engines use the dished piston heads, because It has the advantage of increasing the air turbulence and improving the oil and air mixing quality.
...
- ˈrektæŋɡl、ˈedʒɪz、ˈsiːlɪŋ、ˈskreɪpər

The illustration shows five types of piston rings. The first figure
shows a rectangle ring, the second figure shows a ladder-shaped
ring, the third figure shows a beveling ring, the fourth figure shows a
twist ring and the fifth figure shows a normal worn piston ring.
...
- ˈdʒe-nə-reɪ-tɪd / ˈkɔːzɪz / dɪsks / pəˈrɪ-fəri / ˈmiːn-waɪl
...
​	It works on the principle of gravity separation.   The oily water separator can **coalesce** small oil droplets to form larger oil drops.  When the oil drops become large enough,  the lower-density oil drops float up and collect at the top of the oily water separator. The water remains at the lower portion and is pumped overboard. The oil is pumped into the sludge tank through a **solenoid** valve.

- ˌkoʊəˈles 、ˈdensəti 、soʊlənɔɪd、θruː
...
​	One day, our ship was on rocks, and we found the engine room flooded. When the engine room flooding occurred, the duty engineer reported to the chief engineer and the brige at once, and sounded  the alarm. All the crew members taken actions according to the  Muster List. At last, we were safe.I think we took the correct actions.
...
​	The muster list is an important document on board. It tells the crew members their position and duties in emergency situations, such as fire, collision, oil spill, abandoning ship, ship grounding and so on. For example, in case of flooding, the chief engineer should go to the engine room and be in general command. As a 2th engineer, I should maneuver the main engine. Some other members should go to stop the flooding and so on.
...
I have heard of a case of evacuating from the engine room.The high pressure oil pipe of the ship's No.1 generator unit was burst.Fuel oil splashed on to the exhaust pipe, causing a big fire in the engine room.After evacuating all the people in the engine room,the enginner released the CO2 firefighting system.At last , The fire was put out. I think they took  the correct  actions .
