...
​	The main items in the system include： the thrust shaft, intermediate shaft, propeller shaft and propeller.
...
- ˈfɪɡjər  / ˈrektæŋɡ(ə)l /  ˈlædər / ˈbevəlɪŋ / wɔːrn
...
- ˌkoʊəˈles 、ˈdensəti 、sɑːlənɔɪd、θruː
...
为了确保船舶的安全航行，与船员沟通是必要的。电话和电报是用来和桥上的军官联络的。如果机舱和驾驶室之间的通讯中断，整艘船将处于危险之中。通讯记录应予保存。因为它们可以在发生事故时作为证据。中午报告也是机舱和驾驶台之间良好的通信手段。

### **2. Noon report.**

​	Noon report is a report sent to the company. Every noon, C/E would read the logbook carefully. According to the parameters in the logbook, he would fill up the engine room noon report. The parameters include pressures, temperatures, oil consumption, and so on. The deck department should make another noon report. These two reports will be exchanged between the two departments at noon.
