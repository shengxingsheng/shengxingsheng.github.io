...
62. What is the Critical Equipment and System?（关键的设备和系统是指什么？）
    - It refers to the equipment and system whose sudden operational failure may result in hazardous situations.
...
63. What are the critical operations and conditions?（什么叫关键操作和临界状态？）
    ...
    - sɪɡˈnɪfɪkənt、rɪsk、ˈkɔːzɪŋ、ˈmeɪdʒər、ˈɪndʒəriz
...
74. What does MARPOL 73/78 consist of?（MARPOL73/78公约由什么组成？）
    - It includes regulations about pollution prevention from ships and six technical annexes.
...
**7 s What should be done if the fire in the engine room has become too big to be**
**controlled?**
...
We will receive them in time and make records.

**11 s Whom do you give the order list?**

I usually give the order list to the agent.

**12 Who carries out the internal audit?**

Usually, the supervisor of the company will come on board ship to carry out the internal
audit.

**13 What shall be done with plastic materials on board?**

Plastic materials on board ship should be discharged to the shore for reception.

**14 Could you list some items to be checked by the PSCO?**

Ship certificates, firefighting equipment, life-saving appliances, pollution prevention
equipment and so on.
